...
<head>
    ...
    <body class="<?php echo e((request()->query('mobile') == '1' ? 'force-mobile' : '') . (request()->is('signs*') ? ' page-signs-theme' : '')); ?>">
    <div class="mobile-container">
        <!-- Mobile Header -->
        <header class="mobile-header">
            <!-- Left side icons -->
            <div class="header-left">
                <?php if (! empty(trim($__env->yieldContent('header-left')))): ?>
            ...
            <div class="header-right">
                <?php if (! empty(trim($__env->yieldContent('header-right')))): ?>
            ...
            <div class="header-center" style="flex:1; text-align:center; align-self:center;">
                ...
                <?php if (! empty(trim($__env->yieldContent('page-subtitle')))): ?>
                    <div class="subtitle"><?php echo $__env->yieldContent('page-subtitle'); ?></div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\xampp\htdocs\a_i_s_l_project\si\resources\views/layouts/mobile.blade.php ENDPATH**/ ?>