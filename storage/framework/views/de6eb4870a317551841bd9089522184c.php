<?php $__env->startSection('title', 'مكتبة الإشارات - AISL'); ?>
<?php $__env->startSection('page-title', 'مكتبة الإشارات'); ?>
<?php $__env->startSection('page-subtitle', 'تعلم لغة الإشارة'); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a_i_s_l_project\si\resources\views/signs.blade.php ENDPATH**/ ?>