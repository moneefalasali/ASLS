...
<?php $__env->startSection('page-title','تسجيل الدخول'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group">
                ...
                <input name="email" type="email" class="form-input" value="<?php echo e(old('email')); ?>" required autofocus />
            </div>
            ...
            <div style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-top:8px;">
                ...
                <a class="link" href="<?php echo e(route('password.request')); ?>">نسيت كلمة المرور؟</a>
            </div>

            <div style="margin-top:16px;">
                <button class="btn btn-primary btn-full">دخول</button>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary btn-full" style="margin-top:10px; display:block; text-align:center;">إنشاء حساب</a>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a_i_s_l_project\si\resources\views/auth/login.blade.php ENDPATH**/ ?>